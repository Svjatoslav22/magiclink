...
### Dashboard з картками допомоги
<img src="https://i.imgur.com/your-screenshot-1.png" alt="Dashboard" width="800"/>

*Dashboard з трьома картками збору допомоги: Медична, Гуманітарна (терміново), Підтримка захисників*

### Головна сторінка - Вхід/Реєстрація
<img src="https://i.imgur.com/your-screenshot-2.png" alt="Login Page" width="800"/>

*Форма входу та реєстрації в темному стилі ПриватБанку*
